    ...
    <>
      ...
      <main className="container mx-auto mt-10 p-4 transition-color">
        <section className="text-center">
          ...
          <Link to="/" className="bg-orange-500 text-white px-6 py-3 rounded hover:bg-orange-600">커뮤니티 참여하기</Link>
        </section>
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded shadow dark:bg-gray-800">
              ...
              <Link to="/qna" className="text-orange-500 hover:underline">바로가기</Link>
            </div>
          </div>
        </section>
      </main>
